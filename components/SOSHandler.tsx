  ...
  return (
    <div className="bg-white rounded-lg border border-gray-200 p-6">
      <button
        ...
        className="w-full p-6 bg-red-500 hover:bg-red-600 text-white rounded-lg font-semibold flex flex-col items-center justify-center gap-3 transition transform hover:scale-105"
      >
        ...
        <form onSubmit={handleSubmit} className="mt-6 space-y-4 p-4 bg-gray-50 rounded-lg border border-gray-200">
          ...
          <div className="flex gap-2">
            <button
              type="submit"
              disabled={isLoading}
              className="flex-1 px-4 py-2 bg-red-500 hover:bg-red-600 disabled:bg-gray-400 text-white rounded-lg font-semibold transition flex items-center justify-center gap-2"
            >
              {isLoading ? 'Sending...' : (
                <>
