...
export function RealTimeNotifications() {
  ...
  useEffect(() => {
    const mockNotifications = [
      { id: 1, type: 'alert' as const, message: 'Flood alert in your area - Stay safe!', timestamp: new Date(Date.now() - 2 * 60000) },
      { id: 2, type: 'success' as const, message: 'Emergency contact notified successfully', timestamp: new Date(Date.now() - 5 * 60000) },
      { id: 3, type: 'info' as const, message: 'New resources available nearby', timestamp: new Date(Date.now() - 10 * 60000) },
    ]
