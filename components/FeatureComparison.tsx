...
export function FeatureComparison() {
  ...
  const comparisons: FeatureComparison[] = [
    { feature: 'Real-time Emergency Services', resqmap: true, competitors: true },
    { feature: 'Accessibility Navigation', resqmap: true, competitors: false },
    { feature: 'Disaster Alerts', resqmap: true, competitors: true },
    { feature: 'SOS Emergency Button', resqmap: true, competitors: false },
    { feature: 'Community Reporting', resqmap: true, competitors: false },
    { feature: 'Multi-language Support', resqmap: true, competitors: true },
    { feature: 'Dark Mode', resqmap: true, competitors: false },
    { feature: 'Offline Access (PWA)', resqmap: true, competitors: false },
    { feature: 'Resource Directory', resqmap: true, competitors: true },
    { feature: 'Admin Dashboard', resqmap: true, competitors: false },
  ]
