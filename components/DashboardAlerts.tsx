    ...
    const initialAlerts: Alert[] = [
      {
        ...
        type: 'emergency',
        title: 'Flood Alert',
        message: 'Flash flooding detected in downtown area. Evacuate to higher ground immediately.',
      ...
      },
      {
        ...
        type: 'warning',
        title: 'Fire Outbreak',
        message: 'Major fire reported 2km away. Shelters are opening. Check for accessible evacuation routes.',
      ...
      },
      {
        ...
        message: 'Medical supplies restocked at Central Hospital. Vaccine clinic available now.',
  ...
  return (
    <div className="w-full bg-gradient-to-br from-gray-900 to-gray-950 rounded-lg border border-gray-700 overflow-hidden">
      ...
      <div className="p-6 min-h-96 max-h-96 overflow-y-auto">
          ...
          <div className="space-y-4">
            {visibleAlerts.length === 0 ? (
              ...
              visibleAlerts.map((alert) => (
                <div
                  key={alert.id}
                  className={`border-l-4 rounded-lg p-4 ${getAlertColor(alert.priority)} transition-all hover:shadow-lg`}
                >
                      ...
                      <div className="flex items-start justify-between gap-2">
                        ...
                        <div className="flex gap-1 flex-shrink-0">
                          <button
                            ...
                            className="px-2 py-1 bg-gray-300 hover:bg-gray-400 text-gray-900 rounded text-xs font-semibold transition"
                          >
                            Mark
                          </button>
                          <button
        ...
        {activeTab === 'feeds' && (
          <div className="space-y-3">
            {dataFeeds.map((feed) => (
              <div key={feed.id} className="bg-gray-800 rounded-lg p-4 border border-gray-700 hover:border-gray-600 transition">
                <div className="flex items-center justify-between">
        ...
        {activeTab === 'routes' && (
          <div className="space-y-3">
            <div className="grid grid-cols-1 gap-3">
              {[
                { name: 'Emergency Exit Route 1', difficulty: 'Easy', distance: '0.5 km', time: '6 min', accessibility: 95 },
                { name: 'Safe Highway Route', difficulty: 'Easy', distance: '1.2 km', time: '15 min', accessibility: 100 },
                { name: 'Shelter Access Path', difficulty: 'Moderate', distance: '0.8 km', time: '10 min', accessibility: 85 },
              ].map((route, idx) => (
                <div key={idx} className="bg-gray-800 rounded-lg p-4 border border-green-700 hover:border-green-500 transition">
                  ...
                  <button className="w-full mt-3 bg-green-600 hover:bg-green-700 text-white py-2 rounded-lg font-semibold text-sm transition">
                    Navigate Route
                  </button>
                </div>
              ))}
        ...
        {activeTab === 'sos' && (
          <div className="space-y-4">
            <button
              ...
              className="w-full p-6 bg-gradient-to-r from-red-600 to-pink-600 hover:from-red-700 hover:to-pink-700 text-white rounded-lg font-bold flex flex-col items-center justify-center gap-3 transition transform hover:scale-105 active:scale-95"
            >
              ...
              <div className="bg-gray-800 rounded-lg p-4 border border-red-600 space-y-4">
                ...
                <div>
                  ...
                  <textarea
                    ...
                    className="w-full px-3 py-2 bg-gray-700 border border-gray-600 rounded-lg text-white placeholder-gray-500 focus:outline-none focus:ring-2 focus:ring-red-500 resize-none h-24"
                  />
                </div>
                ...
                <div className="flex gap-2">
                  <button
                    ...
                    className="flex-1 px-4 py-3 bg-red-600 hover:bg-red-700 text-white rounded-lg font-bold transition flex items-center justify-center gap-2"
                  >
            ...
            <div className="bg-blue-900 border border-blue-600 rounded-lg p-4">
              ...
              <div className="space-y-2">
                <button className="w-full py-2 px-3 bg-blue-700 hover:bg-blue-600 text-white rounded-lg font-semibold text-sm transition">
                  Call Emergency (911)
                </button>
                <button className="w-full py-2 px-3 bg-blue-700 hover:bg-blue-600 text-white rounded-lg font-semibold text-sm transition">
      ...
      <div className="bg-gray-800 border-t border-gray-700 px-6 py-3 flex items-center justify-between text-xs text-gray-400">
        ...
        <button className="text-gray-500 hover:text-white transition text-xs font-semibold">
          Settings
        </button>
      </div>
    </div>
